...
public class StatusBarUtils {
    ...
    private int mColor = -1;//状态栏颜色
    private Drawable mDrawable;//状态栏drawble
    private boolean mIsDrawerLayout;//是否是最外层布局是 DrawerLayout 的侧滑菜单
    private boolean mIsActionBar;//是否包含 ActionBar
    private int mContentResourseIdInDrawer; //侧滑菜单页面的内容视图
