 ...
 * 金属锁
 */
class GenMetalActivity : BaseActivity() {
    ...
    private var binding: ActivityGenMetalBinding? = null
    protected var vm: MainVm? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_gen_metal)
