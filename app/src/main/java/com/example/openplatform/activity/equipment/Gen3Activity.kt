 ...
 * 三代锁
 */
class Gen3Activity : AppCompatActivity() {
    ...
    fun deviceToken() { //获取Token
        ...
        data["typeId"] = 10
        vm!!.getDeviceToken(
            this, Config.httpURL + "/system/api/device/common/getDeviceToken", data, Api_Token
        )
    }
    ...
    fun keyPodUnlockCmd() { //开锁
        ...
        vm!!.getKeyPodUnlockCmd(
            this, Config.httpURL + "/system/api/device/keyPod/getKeyPodUnlockCmd", data, Api_Token
        )
    }
    ...
    fun keyPodLockCmd() { //关锁
        ...
        data["typeId"] = 6
        vm!!.getKeyPodLockCmd(
            this, Config.httpURL + "/system/api/device/keyPod/getKeyPodLockCmd", data, Api_Token
        )
    }
