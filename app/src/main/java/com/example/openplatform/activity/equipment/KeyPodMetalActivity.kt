...
import com.example.openplatform.databinding.ActivityFemBoyBinding
import com.example.openplatform.databinding.ActivityKeyPodMetalBinding
 ...
 * 金属钥匙盒
 */
class KeyPodMetalActivity : BaseActivity() {
    ...
    private var binding: ActivityKeyPodMetalBinding? = null
    protected var vm: MainVm? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_key_pod_metal)
    ...
    fun deviceToken() { //获取Token
        ...
        data["typeId"] = 20
        vm!!.getDeviceToken(this, Config.httpURL + "/system/api/device/keypodMetal/getToyToken", data, Api_Token)
    }
    ...
    fun decryBluetoothCommand(string: String?) { //解密
        ...
        data["serialNumber"] = serialNumber
        vm!!.decryBluetoothCommand(this, Config.httpURL + "/system/api/device/keypodMetal/decryBluetoothCommand", data, Api_Token)
    }
    ...
    fun keyPodUnlockCmd() { //开锁
        ...
        data["serialNumber"] = serialNumber
        data["typeId"] = 20
        vm!!.getKeyPodUnlockCmd(this, Config.httpURL + "/system/api/device/keypodMetal/getKeyPodMetalUnlock", data, Api_Token)
    }
    ...
    fun keyPodLockCmd() { //关锁
        ...
        data["serialNumber"] = serialNumber
        data["typeId"] = 20
        vm!!.getKeyPodLockCmd(this, Config.httpURL + "/system/api/device/keypodMetal/getKeyPodMetalLock", data, Api_Token)
    }
    ...
    fun buildCellMateProTimingUnlock() { //定时开锁
        ...
        vm!!.buildCellMateProTimingUnlock(this, Config.httpURL + "/system/api/device/keypodMetal/getKeyPodMetalTiming", data, Api_Token)
    }

    fun buildCellMateProClearTimingUnlockCmd() { //清除定时开锁
        vm!!.buildCellMateProClearTimingUnlockCmd(this, Config.httpURL + "/system/api/device/keypodMetal/getKeyPodMetalCancelTiming", createLockCmdData(), Api_Token)
    }
