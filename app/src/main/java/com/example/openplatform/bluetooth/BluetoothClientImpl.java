...
import static com.example.openplatform.bluetooth.Constants.EXTRA_GATT_PROFILE;
...
import static com.example.openplatform.bluetooth.Constants.EXTRA_RSSI;
...
import static com.example.openplatform.bluetooth.Constants.SERVICE_UNREADY;
...
import com.example.openplatform.bluetooth.connect.response.BluetoothResponse;
import com.example.openplatform.bluetooth.model.BleGattProfile;
import com.example.openplatform.bluetooth.receiver.BluetoothReceiver;
import com.example.openplatform.bluetooth.receiver.listener.BleCharacterChangeListener;
import com.example.openplatform.bluetooth.receiver.listener.BleConnectStatusChangeListener;
import com.example.openplatform.bluetooth.receiver.listener.BluetoothBondListener;
import com.example.openplatform.bluetooth.receiver.listener.BluetoothBondStateChangeListener;
import com.example.openplatform.bluetooth.receiver.listener.BluetoothStateChangeListener;
...
public class BluetoothClientImpl implements IBluetoothClient, ProxyInterceptor, Callback {
    ...
    private final HashMap<String, HashMap<String, List<BleNotifyResponse>>> mNotifyResponses;
    private final HashMap<String, List<BleConnectStatusListener>> mConnectStatusListeners;
    private final List<BluetoothStateListener> mBluetoothStateListeners;
    private final List<BluetoothBondListener> mBluetoothBondListeners;
